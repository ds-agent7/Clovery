...
st.write("(Анализ последней ситуации, графики, сводная таблица predict, 1/2 постпроцессинг)")
...
for path in files:
    ...
    if button:
        ...
        for hole in data.hole.unique():
            ...
            # вывод сводной таблицы предиктов:
            st.write(data[['Date/Time', 'predict_class', 'predict_1']])
